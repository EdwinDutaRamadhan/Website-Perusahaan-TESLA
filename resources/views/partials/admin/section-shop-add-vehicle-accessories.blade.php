  <!-- Modal -->
  <div class="modal fade" id="insert-vehicle" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">T E S L A | Insert Vehicle Accessories</h5>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4">
                              <div class="mt-3">
                                  ...
                                  <input name="image" class="form-control" type="file" id="imageVehicle"
                                      onchange="previewImageVehicle()">
                                  <img class="image-preview-vehicle img-fluid">
                              </div>
                          </div>
                      </div>
                  </div>
