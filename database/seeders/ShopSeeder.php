...
class ShopSeeder extends Seeder
{
    ...
    {
        $shops = array(
            array('id' => '59','category_id' => '1','user_id' => '1','type' => 'At Home','model' => NULL,'title' => 'J1772 Wall Connector','price' => '550','desc' => 'Our J1772 Wall Connector is a convenient charging solution for Tesla and non-Tesla electric vehicles alike, and is ideal for houses, apartments, hospitality properties and workplaces. 
                        ...
                        If you are a developer, manager or owner of commercial real estate and interested in purchasing more than 12 J1772 Wall Connectors, visit Commercial Charging.','image' => 'shop-images/6WH7CsrLpkU5SpWY8gbHdi3UnsMaUWydz7Mm2cQu.webp','created_at' => '2022-12-05 07:55:12','updated_at' => '2022-12-05 08:00:45'),
            array('id' => '2','category_id' => '1','user_id' => '4','type' => 'At Home','model' => NULL,'title' => 'Wall Connector','price' => '400','desc' => 'Wall Connector is the most convenient charging solution for houses, apartments, hospitality properties and workplaces.\\r\\n\\r\\nWith up to 44 miles of range added per hour of charging, a 24 foot cable length, multiple power settings, and a versatile indoor/outdoor design, Wall Connector provides unparalleled convenience.\\r\\n\\r\\nWall Connectors can power-share to maximize existing electrical capacity, automatically distributing power to charge multiple cars simultaneously.\\r\\n\\r\\nIf you are a developer, manager or owner of commercial real estate and interested in purchasing more than 12 Wall Connectors, contact CommercialCharging@tesla.com.','image' => 'shop-images/YWPzF8mQCvqI4Vw8IfRSDXUCe8rJELNIwIglXNtV.avif','created_at' => '2022-11-29 08:32:21','updated_at' => '2022-12-09 20:15:53'),
            ...
            array('id' => '8','category_id' => '4','user_id' => '4','type' => 'Mini Teslas','model' => NULL,'title' => 'Diecast 1:18 Scale Model 3','price' => '180','desc' => 'Officially commissioned by Tesla, the Model 3 Performance diecast scale model was meticulously overseen by the Tesla Design Studio. Every detail, curve and surface was replicated from the same 3D CAD data used to manufacture the actual Model 3 Performance.
                                        
                                        Features:
                                        
                                        Dimensions: 260mm long x113mm wide x 80mm high 
                                        Weight: 2.38lbs (1.08kg)
                                        Warning: Choking hazard. Contains small parts. Not suitable for children under 14 years old.','image' => 'shop-images/G9TpJC5g95DqBAqp2foulaj749lgnQocgzHZ4sBu.webp','created_at' => '2022-11-30 09:54:19','updated_at' => '2022-12-09 20:16:43'),
            ...
            array('id' => '41','category_id' => '4','user_id' => '4','type' => 'Outdoor and Tech','model' => NULL,'title' => 'Umbrella','price' => '60','desc' => 'Designed for sturdy all-weather protection and exceptional coverage, the Tesla Umbrella features a large 62-inch canopy with room for two adults. The heavy-duty red fiberglass frame extends from an ergonomically designed handle for extra comfort.
                                        
                                        Perfect for any outdoor activity, the printed canopy features a prominent logo on the outside with a Tesla wordmark underneath, on the storage sleeve and molded directly into the handle. A black rubber ferrule with red plastic tips adds extra visibility and style.','image' => 'shop-images/G0VMOQkf0WJlO647c9UjVNCEMZ8KRTHNp4mf3HPW.webp','created_at' => '2022-12-01 12:52:43','updated_at' => '2022-12-09 20:16:33'),
            ...
            array('id' => '28','category_id' => '2','user_id' => '4','type' => 'Eksterior','model' => 'Model X','title' => 'Model X Car Cover Outdoor','price' => '450','desc' => 'Outdoor
                                        ...
                                        1x car cover
                                        1x storage bag','image' => 'shop-images/6RMERTtFORFg0eNYXGcrSO246wY0s56TxSmZeDwR.webp','created_at' => '2022-12-01 02:44:07','updated_at' => '2022-12-09 20:17:04'),
            ...
            array('id' => '33','category_id' => '2','user_id' => '4','type' => 'Eksterior','model' => 'Model Y','title' => 'Model Y Tow Package','price' => '1300','desc' => 'Equip your Model Y with a high-strength steel tow bar and 2” hitch receiver capable of towing up to 3,500 pounds on all wheel configurations.
            ...
            array('id' => '47','category_id' => '1','user_id' => '4','type' => 'At Home','model' => NULL,'title' => 'Pedestal for Wall Connector','price' => '425','desc' => 'The Pedestal for Wall Connector is a rugged aluminum post designed for mounting both Gen 3 and Gen 2 Wall Connectors for stand-alone charging. With easy indoor and outdoor installation options, the pedestal is ideal for any driveway, parking lot or property that requires a free-standing structure to support charging equipment. The Pedestal for Wall Connector supports both single and dual mounted configurations for charging one or two Tesla vehicles at the same time.
                              ...
                              Note: Wall Connector(s) and installation are not included. Wall Connectors can be purchased here.','image' => 'shop-images/YrBTGSnkuoA9ax0PwoDxdc9fNz4kmLVUioIcnpQe.webp','created_at' => '2022-12-02 01:34:13','updated_at' => '2022-12-09 20:18:40'),
            array('id' => '48','category_id' => '3','user_id' => '4','type' => 'Sweathshirts and Hoodies','model' => 'Men','title' => 'Chill Pullover Hoodie','price' => '90','desc' => 'Introducing the Tesla Chill Collection. The Chill Pullover Hoodie has a premium, heavyweight exterior and soft fleece interior for comfort in any season. The unisex hoodie features subtle thermoplastic polyurethane Tesla logos across the chest and on the sleeve, a double layer single seam hood and pockets with custom matte zipper pulls. Made from 60% cotton and 40% recycled polyester.','image' => 'shop-images/xvPTESr97hyNeBmymJq8dLxSb6o67wjHyEojm28M.webp','created_at' => '2022-12-02 06:29:52','updated_at' => '2022-12-09 20:17:21'),
            ...
            array('id' => '54','category_id' => '3','user_id' => '4','type' => 'Sweathshirts and Hoodies','model' => 'Women','title' => 'Women\'s Raven Slouchy Crew Sweatshirt','price' => '110','desc' => 'Introducing the Tesla Raven Collection. The Women\'s Raven Slouchy Crew Sweatshirt has a premium, relaxed silhouette made from a sustainable bamboo cotton blend. The slouchy crew features a subtle thermoplastic polyurethane Tesla wordmark on the left sleeve and a french terry interior for a cozy look and feel in every season. Pair it with your Raven Joggers or favorite on the go fit. Made from 70% bamboo and 30% cotton.','image' => 'shop-images/kE0p9JfaMz7TOxTKTgLGKdpo4LrSD8wsKqmrjbYT.webp','created_at' => '2022-12-02 06:45:11','updated_at' => '2022-12-09 20:18:53'),
            ...
            array('id' => '60','category_id' => '1','user_id' => '1','type' => 'On the Road','model' => NULL,'title' => 'Corded Mobile Connector','price' => '200','desc' => 'The Corded Mobile Connector features a NEMA 14-50 plug and improved charging speeds in comparison to the Mobile Connector with NEMA 5-15 Adapter. 
                        
                        Includes:
                        
                        1x NEMA 14-50 Corded Mobile Connector - 20’ cable
                        1x storage bag','image' => 'shop-images/yAfmfk1hklEBNdLOb7vn2nZhM9mDDRuGpBYnD0cG.webp','created_at' => '2022-12-05 07:58:20','updated_at' => '2022-12-05 07:58:20')
          );
